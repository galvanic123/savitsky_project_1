...
def test_getting_data_account(mock_read_excel):           # type: ignore[no-untyped-def]
    file_name = "test.xlsx"
...
def test_get_greeting(date, expected):         # type: ignore[no-untyped-def]
...
def test_get_response(date, expected):        # type: ignore[no-untyped-def]
    assert get_response(date) == expected


def test_filter_by_period(transactions):         # type: ignore[no-untyped-def]
...
def test_information_cards(transactions):            # type: ignore[no-untyped-def]
...
def test_getting_top_specified_period(transactions_data):      # type: ignore[no-untyped-def]
...
@patch("requests.get")
def test_getting_data_currencie(mock_get):             # type: ignore[no-untyped-def]
...
@patch("requests.get")
def test_getting_data_currencie_error(mock_get):              # type: ignore[no-untyped-def]
    api = "https://api.example.com"
...
def test_getting_data_stock_prices_success():              # type: ignore[no-untyped-def]
...
@patch("requests.get")
def test_getting_data_stock_prices_error(mock_get):     # type: ignore[no-untyped-def]
    api = "https://api.example.com"
