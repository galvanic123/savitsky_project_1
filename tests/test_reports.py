...
def test_log_file_params(transactions_data):        # type: ignore[no-untyped-def]
    @write_to_file_params("function_report.txt")
    def spending_category(transactions, category, date):      # type: ignore[no-untyped-def]
...
def test_log_file(transactions_data):           # type: ignore[no-untyped-def]
    @my_decorator
    def spending_category(transactions, category, date):           # type: ignore[no-untyped-def]
...
def test_spending_by_category(transactions_data):       # type: ignore[no-untyped-def]
