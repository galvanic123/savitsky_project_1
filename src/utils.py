...
json_file_path = os.path.join("C:/Users/Dell/PycharmProjects/savitsky_project_1/data/operations.xlsx")
...
def information_cards(transactions: list[dict]) -> list[dict]:
