...
def write_to_file_params(file_name: str) -> str:
...
def spending_by_category(transactions: pd.DataFrame, category: str, date: Optional[str] = None) -> pd.DataFrame:
    ...
    if date is None:
        ...
        logger.info("Преобразование в datetime заданной даты")
    ...
    logger.info("Формируем группу отфильтрованных транзакций и выводим их сумму")
